...
(11) NOT NULL,
  `name` varchar
(20) COLLATE utf8_bin NOT NULL,
  `surname` varchar
(20) COLLATE utf8_bin NOT NULL,
  `gender` enum
('vyras','moteris','','') COLLATE utf8_bin DEFAULT NULL,
  `phone` varchar
(12) COLLATE utf8_bin DEFAULT NULL,
  `birthday` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON
UPDATE CURRENT_TIMESTAMP,
  `education
` varchar
(120) COLLATE utf8_bin DEFAULT NULL,
  `salary` int
(11) DEFAULT NULL,
  `idarbinimo_tipas` tinyint
(4) DEFAULT NULL,
  `pareigos_id` int
(11) DEFAULT NULL
...
id`,
`name
`, `surname`, `gender`, `phone`, `birthday`, `education`, `salary`, `idarbinimo_tipas`, `pareigos_id`) VALUES
...
--
ALTER TABLE `darbuotojai`
ADD CONSTRAINT `darbuotojai_ibfk_1` FOREIGN KEY
(`pareigos_id`) REFERENCES `pareigos`
(`id`);
